...
namespace OstEnterpriseSearch;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstEnterpriseSearch extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_enterprise_search.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_enterprise_search.view_dir', $this->getPath() . '/Resources/views/');
